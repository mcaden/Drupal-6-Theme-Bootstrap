...
?>
<table id="blocks" class="sticky-enabled table">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <?php foreach ($block_regions as $region => $title): ?>
      ...
      <tr class="draggable <?php print $row % 2 == 0 ? 'odd' : 'even'; ?><?php print $data->row_class ? ' '. $data->row_class : ''; ?>">
        ...
        <?php endif; ?>
        <td><?php print str_replace('>configure<', ' class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span><',$data->configure_link); ?></td>
        <td><?php print str_replace('>delete<', ' class="btn btn-default btn-danger"><span class="glyphicon glyphicon-remove"></span><',$data->delete_link); ?></td>
      </tr>
      <?php $row++; ?>
      <?php endforeach; ?>
    <?php endforeach; ?>
